PalladiumEvents.registerAnimations((event) => {
    ...
    event.registerForPower('airline_heroes/flash_step_animation', 'airline_heroes:gas', 5, (builder) => {
        const progress = animationUtil.getAnimationTimerAbilityValue(builder.getPlayer(), 'airline_heroes:gas', 'flash_step_animation', builder.getPartialTicks());
        if (progress > 0.0) {
            if (progress > 0.0) {
                builder.get('left_leg')
                    .setXRotDegrees(-40)
    ...
    event.registerForPower('airline_heroes/vapor_kick_animation', 'airline_heroes:gas', 5, (builder) => {
        const progress = animationUtil.getAnimationTimerAbilityValue(builder.getPlayer(), 'airline_heroes:gas', 'vapor_kick_animation', builder.getPartialTicks());
        if (progress > 0.0) {
            builder.get('left_leg')
                .setXRotDegrees(-90)
            builder.get('right_leg')
